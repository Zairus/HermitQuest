...
public class ItemFalseGoogles extends ItemArmor
{
	public ItemFalseGoogles()
	{
		super(MaterialHelper.FALSE_GOOGLES, 0, EntityEquipmentSlot.HEAD);
	...
	public void onUpdate(ItemStack stack, World world, Entity entity, int itemSlot, boolean isSelected)
	{
		if (itemSlot == 3)
		{
			if (entity instanceof EntityPlayer)
			{
				...
				Potion effect = MobEffects.NIGHT_VISION;
