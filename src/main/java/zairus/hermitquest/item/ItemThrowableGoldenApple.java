...
public class ItemThrowableGoldenApple extends Item
{
	public ItemThrowableGoldenApple()
	{
	...
	public ActionResult<ItemStack> onItemRightClick(ItemStack itemStack, World world, EntityPlayer player, EnumHand hand)
	{
		...
		if (!world.isRemote)
		{
			EntityThrowableGoldenApple entity = new EntityThrowableGoldenApple(world, player);
