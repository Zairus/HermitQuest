package zairus.hermitquest.client.model;
...
public class ModelMiniSnake extends ModelBase
{
	private static final int[][] BODY_SIZES = new int[][] {{2, 2, 5}, {3, 3, 5}, {3, 2, 5}, {1, 1, 3}};
	private static final int[][] BODY_TEXS = new int[][] {{0, 0}, {0, 5}, {0, 0}, {0, 0}};
	private static final int BODY_COUNT = BODY_SIZES.length;
	private final ModelRenderer[] bodyParts;
	
	public ModelMiniSnake()
	{
